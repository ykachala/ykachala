...
I specialise in the hard backend problems — systems that need to be fast, consistent, recoverable, and maintainable at scale. I've rescued systems others gave up on, scaled platforms to 10k+ concurrent users, and shipped production infrastructure for healthcare, government, and financial services.

- **Architecture** — multi-tenant SaaS, event-driven systems, distributed transaction design  
- **Platform engineering** — CI/CD pipelines, containerised deployments, observability stacks  
- **Fintech** — subscription billing, payment gateway integration, idempotent financial workflows  
- **AI integration** — LLM-powered features wired into production backend systems  
...
📍 Cape Town, South Africa &nbsp;|&nbsp; Open to remote & hybrid roles  
📧 yowelikachala@gmail.com &nbsp;|&nbsp; [LinkedIn](https://linkedin.com/in/yoweli-kachala) &nbsp;|&nbsp; [www.caperidaz.com](http://www.caperidaz.com)
